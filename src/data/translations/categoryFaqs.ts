...
export const categoryFaqs: Record<Locale, Record<string, CategoryFaqItem[]>> = {
  en: {
    'cbd-flowers': [
      ...
      { question: 'How fast do CBD flower orders ship?', answer: 'Within 24 hours from our French warehouse, with tracking, to anywhere in Europe. Free delivery applies to orders over €150.' },
    ...
    'cbd-resins': [
      ...
      { question: 'How fast do CBD resin orders ship?', answer: 'Within 24 hours from our French warehouse, with tracking, across Europe. Free delivery applies to orders over €150.' },
    ...
    'cbd-oils': [
      ...
      { question: 'How fast do CBD oil orders ship?', answer: 'Within 24 hours from our French warehouse, with tracking, to anywhere in Europe. Free delivery applies to orders over €150.' },
    ...
    'cbd-gummies': [
      ...
      { question: 'How fast do CBD gummy orders ship?', answer: 'Within 24 hours from our French warehouse, with tracking, across Europe. Free delivery applies to orders over €150.' },
    ...
    'thc-gummies': [
      ...
      { question: 'How fast do THC gummy orders ship?', answer: 'Within 24 hours from our French warehouse, with tracking, across Europe. Free delivery applies to orders over €150.' },
  ...
  nl: {
    'cbd-flowers': [
      ...
      { question: 'Hoe snel worden CBD-bloembestellingen verzonden?', answer: 'Binnen 24 uur vanuit ons Franse magazijn, met tracking, naar heel Europa. Gratis verzending vanaf €150.' },
    ...
    'cbd-resins': [
      ...
      { question: 'Hoe snel worden CBD-harsbestellingen verzonden?', answer: 'Binnen 24 uur vanuit ons Franse magazijn, met tracking, door heel Europa. Gratis verzending vanaf €150.' },
    ...
    'cbd-oils': [
      ...
      { question: 'Hoe snel worden CBD-oliebestellingen verzonden?', answer: 'Binnen 24 uur vanuit ons Franse magazijn, met tracking, naar heel Europa. Gratis verzending vanaf €150.' },
    ...
    'cbd-gummies': [
      ...
      { question: 'Hoe snel worden CBD-gummybestellingen verzonden?', answer: 'Binnen 24 uur vanuit ons Franse magazijn, met tracking, door heel Europa. Gratis verzending vanaf €150.' },
    ...
    'thc-gummies': [
      ...
      { question: 'Hoe snel worden THC-gummybestellingen verzonden?', answer: 'Binnen 24 uur vanuit ons Franse magazijn, met tracking, door heel Europa. Gratis verzending vanaf €150.' },
